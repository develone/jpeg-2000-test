...
input clk;
input signed [25:0] pix_dout_even1;
...
input signed [25:0] pix_dout_odd1;
output signed [25:0] pix_din_even1;
reg signed [25:0] pix_din_even1;
input signed [25:0] pix_dout_odd;
output signed [25:0] pix_din_odd;
reg signed [25:0] pix_din_odd;
input pix_even_odd;
input pix_we_even1;
output signed [25:0] pix_din_odd1;
reg signed [25:0] pix_din_odd1;
input pix_fwd_inv;
    ...
    if ((!pix_p)) begin
        ...
        if (pix_even_odd) begin
            if (pix_fwd_inv) begin
                ...
                pix_din_even1 <= ((pix_left1 + pix_right1) * ca2);
            end
            else begin
            ...
            if (pix_fwd_inv) begin
                ...
                pix_din_odd1 <= ((pix_left1 + pix_right1) * ca1);
            end
            else begin
        ...
        if (pix_even_odd) begin
            if (pix_fwd_inv) begin
                ...
                pix_din_even1 <= ((pix_left1 + pix_right1) * ca4);
            end
            else begin
            ...
            if (pix_fwd_inv) begin
                ...
                pix_din_odd1 <= ((pix_left1 + pix_right1) * ca3);
            end
            else begin
