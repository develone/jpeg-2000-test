...
def jpeg(clk_s, left_s, right_s, sam_s, res_s, even_odd_s , fwd_inv_s  ):
	...
	return hdl
def testbench():
	i_inst = jpeg( clk_s, left_s, right_s, sam_s, res_s, even_odd_s , fwd_inv_s)
...
def convert():			
	toVerilog(jpeg, clk_s, left_s, right_s, sam_s, res_s, even_odd_s , fwd_inv_s)
	toVHDL(jpeg, clk_s, left_s, right_s, sam_s, res_s, even_odd_s , fwd_inv_s)
convert()
