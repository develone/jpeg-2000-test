...
def RamCtrl(          addr0_r, addr0_x,
    ...
    def FSM():
        ...
        if state_r == t_State.INIT:
            ...
            addr_rom_x.next = 0
            addr0_x.next = 0
            """write 0x3A9148A4 to address 0x0000
            then go to the WRITE state writes"""
            addr1_x.next = 0
            dataToRam0_x.next = 982599844
            state_x.next = t_State.WRITE
        elif state_r == t_State.WRITE:
            """writes rom data to sdram
            ...
            if (done0_s == NO) :
                ...
                """Reads 1 location to indicate that the
                sdram ram was written correctly
                start at 0x0000 to 0x0001
                sum_r 0042"""
