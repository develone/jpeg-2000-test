...
def merge( left_com_x, sam_com_x, right_com_x, lft_s_i, sa_s_i, rht_s_i, merge_rdy_s, nomerge_s, W0=3, LVL0=4, W1=3, LVL1=4, W2=3, LVL2=4,  W3=3, LVL3=4, SIMUL=0 ):
...
def convert():
	if (SIMUL == 0):
		...
		dut = toVHDL(merge, left_com_x, sam_com_x, right_com_x, lft_s_i, sa_s_i, rht_s_i, merge_rdy_s, nomerge_s, W0=W0, LVL0=LVL0, W1=W1, LVL1=LVL1, W2=W2, LVL2=LVL2,  W3=W3, LVL3=LVL3, SIMUL=0 )
		dut = toVerilog(merge, left_com_x, sam_com_x, right_com_x, lft_s_i, sa_s_i, rht_s_i, merge_rdy_s, nomerge_s, W0=W0, LVL0=LVL0, W1=W1, LVL1=LVL1, W2=W2, LVL2=LVL2,  W3=W3, LVL3=LVL3, SIMUL=0 )
	else:
