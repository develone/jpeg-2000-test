...
def toplevel(i_clk,i_astb_n,i_dstb_n,i_write_n,to_depp,fr_depp,o_wait,o_wb_cyc,o_wb_stb,o_wb_we, \
...
def tb(i_clk,i_astb_n,i_dstb_n,i_write_n,to_depp,fr_depp,o_wait,o_wb_cyc,o_wb_stb,o_wb_we, \
o_wb_addr,o_wb_data,i_wb_ack,i_wb_stall,i_wb_err,i_wb_data,i_int, \
i_rpi2B, o_rpi2B ):
    dut_rpi2B_io = rpi2B_io(i_rpi2B,fr_depp,o_rpi2B,to_depp)
...
def convert():
	toVerilog(toplevel,i_clk,i_astb_n,i_dstb_n,i_write_n,to_depp,fr_depp,o_wait,o_wb_cyc, \
...
def main():
    args = cliparse()
    if args.trace:
        tb_fsm = traceSignals(tb,i_clk,i_astb_n,i_dstb_n,i_write_n,to_depp,fr_depp,o_wait,o_wb_cyc,o_wb_stb,o_wb_we, \
o_wb_addr,o_wb_data,i_wb_ack,i_wb_stall,i_wb_err,i_wb_data,i_int, \
i_rpi2B, o_rpi2B )
