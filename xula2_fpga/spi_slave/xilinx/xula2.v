...
always @(posedge sck, posedge inst_spi_sl_csn) begin: XULA2_INST_SPI_SL_SCK_CAPTURE_SEND
...
always @(posedge sck, negedge inst_spi_sl_csn) begin: XULA2_INST_SPI_SL_CSN_FALLS
    if (sck) begin
