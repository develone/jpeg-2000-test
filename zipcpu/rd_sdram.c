...
// to compile dwt_steps.c 
// to link dwt_write.o rd_sdram.o zip-gcc -fno-builtin -nostdlib -O3 dwt_write.o rd_sdram.o -o rd_sdram -T xulalink.x
// to disasmble
