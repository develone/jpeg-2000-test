 ...
 * CVS identifier:
 *
 * $Id: Quantizer.java,v 1.1 2006/12/14 20:59:26 devel Exp vidal $
 *
 * Class:                   Quantizer
 *
...
public abstract class Quantizer extends ImgDataAdapter
    ...
    public static Quantizer createAltInstance(CBlkWTDataSrc src,
                                           AltEncoderSpecs encSpec) {
	// Instantiate quantizer
	return new AltStdQuantizer(src,encSpec);
    }
