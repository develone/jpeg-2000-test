 ...
 * CVS identifier:
 *
 * $Id: AltStdQuantizer.java,v 1.1 2006/12/14 20:59:26 devel Exp vidal $
 *
 * Class:                   StdQuantizer
 *
 ...
 * @see Quantizer
 * */
public class AltStdQuantizer extends Quantizer {
    ...
    private AltQuantTypeSpec qts;

    /** The quantization step size specifications */
    private AltQuantStepSizeSpec qsss;

    /** The guard bits specifications */
    private AltGuardBitsSpec gbs;
     ...
     * */
    public AltStdQuantizer(CBlkWTDataSrc src,AltEncoderSpecs encSpec) {
	super(src);
	qts  = encSpec.qts;
        qsss = encSpec.qsss;
        gbs  = encSpec.gbs;
     ...
     * */
    public AltQuantTypeSpec getQuantTypeSpec() {
	return qts;
    }
