 ...
 * CVS identifier:
 *
 * $Id: AltBitstreamReaderAgent.java,v 1.1 2006/12/14 20:59:05 devel Exp vidal $
 *
 ...
 * alone.</p>
 * */
public abstract class AltBitstreamReaderAgent implements CodedCBlkDataSrcDec {
    ...
    protected final AltHeaderDecoder hd;
     ...
     * */
    protected AltBitstreamReaderAgent(AltHeaderDecoder hd,DecoderSpecs decSpec) {
        Coord co;
        int i,j,max;
     ...
     * */
    public static AltBitstreamReaderAgent createInstance(RandomAccessIO in,
            AltHeaderDecoder hd,
            DecoderOptions options,
            DecoderSpecs decSpec,            
            HeaderInfo hi)
            throws IOException {
        return new AltFileBitstreamReaderAgent(hd,in,decSpec,options,hi);
    }
