 ...
 * CVS identifier:
 *
 * $Id: AltHeaderDecoder.java,v 1.1 2006/12/14 20:59:05 devel Exp vidal $
 *
 * Class:                   HeaderDecoder
 *
 ...
 * */
public class AltHeaderDecoder implements ProgressionType, Markers,
     ...
     * */
    public AltHeaderDecoder(RandomAccessIO ehs,DecoderOptions options,HeaderInfo hi)
        throws IOException {
    ...
    public EntropyDecoder createEntropyDecoder(CodedCBlkDataSrcDec src,
        ...
        mMax = options.m_quit;
        return new AltStdEntropyDecoder(src,decSpec,doer,mMax);
     ...
     * */
    public AltROIDeScaler createROIDeScaler(CBlkQuantDataSrcDec src,
                                         DecoderOptions options,
                                         DecoderSpecs decSpec2) {
        return AltROIDeScaler.createInstance(src,options,decSpec2);
    }
