 ...
 * CVS identifier:
 *
 * $Id: AltPktDecoder.java,v 1.1 2006/12/14 20:59:05 devel Exp vidal $
 *
 * Class:                   PktDecoder
 *
 ...
 * method.
 * */
public class AltPktDecoder implements StdEntropyCoderOptions {
    
    /** Reference to the codestream reader agent */
    private AltBitstreamReaderAgent src;
     ...
     *
     * */
    public AltPktDecoder(DecoderSpecs decSpec,AltHeaderDecoder hd,
                      RandomAccessIO ehs,AltBitstreamReaderAgent src,
