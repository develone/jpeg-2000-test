 ...
 * CVS identifier:
 *
 * $Id: AltCodestreamWriter.java,v 1.1 2006/12/14 20:59:05 devel Exp vidal $
 *
 ...
 * @see HeaderEncoder
 * */
public abstract class AltCodestreamWriter {
     ...
     * codestream.
     * */
    protected AltCodestreamWriter(int mb) {
        maxBytes = mb;
    }
     ...
     * called.
     * */
    public abstract void commitBitstreamHeader(AltHeaderEncoder he)
        throws IOException;
