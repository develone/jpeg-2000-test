 ...
 * CVS identifier:
 *
 * $Id: AltFileCodestreamWriter.java,v 1.1 2006/12/14 20:59:05 devel Exp vidal $
 *
 ...
 * */
public class AltFileCodestreamWriter extends AltCodestreamWriter 
    implements Markers {
...
//     * */
//    public AltFileCodestreamWriter(File file, int mb) throws IOException {
//        super(mb);
...
//     * for writing or while writing the magic number.
//     * */
//    public AltFileCodestreamWriter(String fname, int mb) throws IOException {
//        super(mb);
...
//    }
     ...
     * */
    public AltFileCodestreamWriter(OutputStream os, int mb) {
        super(mb);
        out = os;
        initSOP_EPHArrays();
    }
     ...
     * */
    public void commitBitstreamHeader(AltHeaderEncoder he) throws IOException {
        // Actualize ndata
        ndata += he.getLength();
