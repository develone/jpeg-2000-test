 ...
 * CVS identifier:
 * 
 * $Id: AltStdEntropyDecoder.java,v 1.1 2006/12/14 20:59:11 devel Exp vidal $
 * 
 ...
 * */
public class AltStdEntropyDecoder extends EntropyDecoder 
   ...
   /** The flag bit for the horizontal-left sign in the state array, for row
     ...
     * */
    public AltStdEntropyDecoder(CodedCBlkDataSrcDec src, DecoderSpecs decSpec, 
                             boolean doer, int mQuit) {
        super(src);
