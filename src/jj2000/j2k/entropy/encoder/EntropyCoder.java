 ...
 * CVS identifier:
 *
 * $Id: EntropyCoder.java,v 1.1 2006/12/14 20:59:11 devel Exp vidal $
 *
 * Class:                   EntropyCoder
 *
...
public abstract class EntropyCoder extends ImgDataAdapter
    ...
    public static EntropyCoder createAltInstance(CBlkQuantDataSrcEnc src,
                                              EncoderOptions options,
                                              AltCBlkSizeSpec cblks,
                                              AltPrecinctSizeSpec pss,
                                              BooleanSpec bms,BooleanSpec mqrs,
                                              BooleanSpec rts,BooleanSpec css,
                                              BooleanSpec sss,AltIntegerSpec lcs,
                                              AltIntegerSpec tts) {
        
        return new AltStdEntropyCoder(src,cblks,pss,bms,mqrs,rts,css,sss,lcs,tts);
    }
}
