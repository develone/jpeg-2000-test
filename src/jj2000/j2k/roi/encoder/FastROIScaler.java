 ...
 * CVS identifier:
 *
 * $Id: FastROIScaler.java,v 1.1 2006/12/14 20:59:31 devel Exp vidal $
 *
 * Class:                   ROIScaler
 *
 ...
 * @see CBlkWTData
 * */
public class FastROIScaler extends ImgDataAdapter implements CBlkQuantDataSrcEnc {
     ...
     * */
    public FastROIScaler(Quantizer src,
            ROIMaskGenerator mg,
            boolean roi,
            int sLev,
            boolean uba,
     ...
     * the options in 'pl'
     * */
    public static FastROIScaler createInstance(Quantizer src,
        ...
        //if (options.roi_type == -1)      {
            ...
            return new FastROIScaler(src,null,false,-1,false,encSpec);
        //}
    }
/**
 ...
 * @param encSpec The encoder specifications for addition of roi specs
 * */
private void calcMaxMagBits(AltEncoderSpecs encSpec) {
    int tmp;
