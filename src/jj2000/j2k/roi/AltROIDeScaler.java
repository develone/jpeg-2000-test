 ...
 * CVS identifier:
 *
 * $Id: AltROIDeScaler.java,v 1.1 2006/12/14 20:58:57 devel Exp vidal $
 *
 *
 * Class:                   ROIDeScaler
 *
 ...
 * */
public class AltROIDeScaler extends MultiResImgDataAdapter
     ...
     * tile-components
     * */
    public AltROIDeScaler(CBlkQuantDataSrcDec src, MaxShiftSpec mss){
        super(src);
        this.src=src;
        this.mss=mss;
    }
     ...
     * */
    public static AltROIDeScaler createInstance(CBlkQuantDataSrcDec src,
	...
	// in bit stream
        noRoi = options.rno_roi;
        if (noRoi || decSpec.rois==null) {
            // no_roi specified in commandline!
	    return new AltROIDeScaler(src,null);
        }

        return new AltROIDeScaler(src,decSpec.rois);
    }
}
