 ...
 * CVS identifier:
 *
 * $Id: AltForwWTFull.java,v 1.1 2006/12/14 20:59:36 devel Exp vidal $
 *
 * Class:                   ForwWTFull
 *
 ...
 * @see ForwardWT
 * */
public class AltForwWTFull extends ForwardWT {
    ...
    private AltAnWTFilterSpec filters;
     ...
     * @see ForwardWT
     * */
    public AltForwWTFull(BlkImgDataSrc src,AltEncoderSpecs encSpec,
                      int cb0x,int cb0y) {
        super(src);
        this.src  = src;
        this.cb0x  = cb0x;
