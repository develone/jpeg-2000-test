 ...
 * CVS Identifier:
 *
 * $Id: AltInvCompTransf.java,v 1.1 2006/12/14 20:59:21 devel Exp vidal $
 *
 * Class:               InvCompTransf
 *
 ...
 * @see ModuleSpec
 * */
public class AltInvCompTransf extends ImgDataAdapter implements BlkImgDataSrc {
     ...
     * @see BlkImgDataSrc
     * */
    public AltInvCompTransf(BlkImgDataSrc imgSrc, DecoderSpecs decSpec,
                         int[] utdepth, DecoderOptions options) {
        super(imgSrc);
	this.cts = decSpec.cts;
        this.wfs = decSpec.wfs;
        src = imgSrc;
        this.utdepth = utdepth;
        noCompTransf = !options.comp_transf;
    }   
