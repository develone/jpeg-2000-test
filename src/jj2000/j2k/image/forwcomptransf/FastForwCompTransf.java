 ...
 * CVS Identifier:
 *
 * $Id: FastForwCompTransf.java,v 1.1 2006/12/14 20:59:21 devel Exp vidal $
 *
 ...
 * @see ModuleSpec
 * */
public class FastForwCompTransf extends ImgDataAdapter implements BlkImgDataSrc {
     ...
     * @see BlkImgDataSrc
     * */
    public FastForwCompTransf(BlkImgDataSrc imgSrc, AltEncoderSpecs encSpec) {
        super(imgSrc);
