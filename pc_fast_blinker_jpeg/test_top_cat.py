...
def dwt_top(clock,si0,fB0,si1,fB1,si2,fB2,si3,fB3,reset_i,pp0,ss0,ld):
	...
	instance_17 = lift2res(lift8,res8, lift9,res9, lift10,res10, lift11,res11, lift12,res12, lift13,res13,lift14,res14,lift15,res15)
        ...
        instance_30 = ShiftReg(clock, WIDTH, reset_i, fB0, si0, po0)
        instance_31 = toSig(clock, sig0,flgs0,lft0,sam0,rht0, upd0)
        instance_32 = ShiftReg(clock, WIDTH, reset_i, fB1, si1, po1)
        instance_33 = toSig(clock, sig1,flgs1,lft1,sam1,rht1, upd1)
        instance_34 = ShiftReg(clock, WIDTH, reset_i, fB2, si2, po2)
        instance_35 = toSig(clock, sig2,flgs2,lft2,sam2,rht2, upd2)
        instance_36 = ShiftReg(clock, WIDTH, reset_i, fB3, si3, po3)
        instance_37 = toSig(clock, sig3,flgs3,lft3,sam3,rht3, upd3)  
        instance_38 = ShiftReg(clock, WIDTH, reset_i, fB4, si4, po4)
        instance_39 = toSig(clock, sig4,flgs4,lft4,sam4,rht4, upd4)
        instance_40 = ShiftReg(clock, WIDTH, reset_i, fB5, si5, po5)
        instance_41 = toSig(clock, sig5,flgs5,lft5,sam5,rht5, upd5)
        instance_42 = ShiftReg(clock, WIDTH, reset_i, fB6, si6, po6)
        instance_43 = toSig(clock, sig6,flgs6,lft6,sam6,rht6, upd6)
        instance_44 = ShiftReg(clock, WIDTH, reset_i, fB7, si7, po7)
        instance_45 = toSig(clock, sig7,flgs7,lft7,sam7,rht7, upd7)
  
        instance_50 = ShiftReg(clock, WIDTH, reset_i, fB8, si8, po8)
        instance_51 = toSig(clock, sig8,flgs8,lft8,sam8,rht8, upd8)
        instance_52 = ShiftReg(clock, WIDTH, reset_i, fB9, si9, po9)
        instance_53 = toSig(clock, sig9,flgs9,lft9,sam9,rht9, upd9)
        instance_54 = ShiftReg(clock, WIDTH, reset_i, fB10, si10, po10)
        instance_55 = toSig(clock, sig10,flgs10,lft10,sam10,rht10, upd10)
        instance_56 = ShiftReg(clock, WIDTH, reset_i, fB11, si11, po11)
        instance_57 = toSig(clock, sig11,flgs11,lft11,sam11,rht11, upd11)  
        instance_58 = ShiftReg(clock, WIDTH, reset_i, fB12, si12, po12)
        instance_59 = toSig(clock, sig12,flgs12,lft12,sam12,rht12, upd12)
        instance_60 = ShiftReg(clock, WIDTH, reset_i, fB13, si13, po13)
        instance_61 = toSig(clock, sig13,flgs13,lft13,sam13,rht13, upd13)
        instance_62 = ShiftReg(clock, WIDTH, reset_i, fB14, si14, po14)
        instance_63 = toSig(clock, sig14,flgs14,lft14,sam14,rht14, upd14)
        instance_64 = ShiftReg(clock, WIDTH, reset_i, fB15, si15, po15)
	...
	instance_85 = signed2twoscomplement(res15, z15)
        ...
        instance_100 = input_pin(reset_i, reset, pullup=True)
	return instances()	

 
def tb(clock,si0,fB0,si1,fB1,si2,fB2,si3,fB3,reset_i,pp0,ss0,ld):
...
def convert(args):
    toVerilog(dwt_top,clock,si0,fB0,si1,fB1,si2,fB2,si3,fB3,reset_i,pp0,ss0,ld)
    #toVHDL(dwt_top,clock)
 
def main():
    args = cliparse()
    if args.test:
       tb_fsm = traceSignals(tb,clock,si0,fB0,si1,fB1,si2,fB2,si3,fB3,reset_i,pp0,ss0,ld)
